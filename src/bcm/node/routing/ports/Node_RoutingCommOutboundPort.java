...
/**
 * classe du port sortant "Node_RoutingCommOutboundPort"
...
public class Node_RoutingCommOutboundPort extends AbstractOutboundPort implements CommunicationCI{
	...
	/** appel au service de connexion d'un Node_Routing a un voisin */
	@Override
	public void connect(NodeAddressI address, String communicationInboundPortURI) throws Exception {
		((CommunicationCI)this.getConnector()).connect(address, communicationInboundPortURI);
	}

	/** appel au service de connexion d'un Node_Routing  a un voisin qui a la capacité à router des messages  */
	@Override
